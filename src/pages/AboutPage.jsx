    ...
    <>
      ...
      <div className="container my-3 py-3">
        ...
        <p className="lead text-center">
          At <strong>Vivid Pulse</strong>, we believe in the power of passion and <strong>self-expression</strong>. Our store was born from a desire to create a **vibrant space** where style meets quality, offering a curated collection of products that resonate with your inner energy. We're more than just an e-commerce platform; we're a community for those who live life with a **vivid pulse**.
        </p>
        <p className="lead text-center">
          Every piece in our collection is handpicked to ensure it meets our **high standards of quality** and **unique design**. Whether you’re looking for the perfect outfit, a stunning piece of jewelry, or the latest gadget, we are here to help you find products that not only look great but also feel right.
        </p>
